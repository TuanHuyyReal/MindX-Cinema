  ...
  Object.keys(data).map((key, index) => {
    ...
    <div class="section">
      ...
      <div class="swiper-${index} swiper">
        ...
        <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-08410a83b39843a96">::after</div>
        <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-08410a83b39843a96"> ::after</div>
      </div>
    </div>
    `;
  });
